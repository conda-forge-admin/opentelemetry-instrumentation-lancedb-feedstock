...
pixi add opentelemetry-instrumentation-lancedb
# for installing globally
pixi global install opentelemetry-instrumentation-lancedb
```
...
It is possible to list all of the versions of `opentelemetry-instrumentation-lancedb` available on your platform:
...
```
pixi search opentelemetry-instrumentation-lancedb --channel conda-forge
```
